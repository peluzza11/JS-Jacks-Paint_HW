function configureListeners() {
    var images = document.getElementsByTagName('img')// select img elements  
     ...
     for (var i = 0; i < images.length; i++) {        
        document.getElementById(images[i].id.addEventListener('moseover', addOpacity, false))
        document.getElementById(images[i].id.addEventListener('moseout', removeOpacity, false))// iterate over images and add mouseover event listeners      
    } 
}
